...
## Initial Request — 2026-06-30T10:15:59+05:30
...
## Follow-up — 2026-06-30T04:54:04Z

We have updated the project requirements to include a new capability: **On-Device Wake-Word Detection** (R6). 

Please review the updated requirements in the prompt draft at `/Users/mohammedarif/.gemini/antigravity/brain/16732ed6-6f13-45bc-a6f4-428052b8006d/prompt_draft.md` and propagate them down to the Project Orchestrator (ID: `c86685ba-0e81-4f1c-8b80-38b87e48c6f9`) and the sub-orchestrators (Implementation Track & E2E Testing Track) so that the new `core-wakeword` crate and wake-word state machine are built and verified.
